...
export default function ExperienceAccordion() {
    return (
        <div className="space-y-2">
            <Drawer title="Cloud Transit Xchange — Lead Full-Stack Engineer" meta="06/2024 – 06/2025">
                <ul className="drawer-list list-disc">
                    <li>Developed and maintained UIs with React Native, ReactJS, HTML5, CSS3, and ES6+.</li>
            ...
            <Drawer title="Dacodes — Full Stack Developer" meta="05/2023 – 06/2024">
                <ul className="drawer-list list-disc">
            ...
            <Drawer title="Coppel — Software Developer" meta="08/2018 – 04/2023">
                <ul className="drawer-list list-disc">
            ...
            <Drawer title="Cabezut — Engineer in Software Development" meta="04/2015 – 06/2018">
                <ul className="drawer-list list-disc">
            ...
            <Drawer title="Freelancer — Full-Stack Developer" meta="04/2012 – Present">
                <ul className="drawer-list list-disc">
